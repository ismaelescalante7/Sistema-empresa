...
const form = useForm({
  razon_social: null,
  cuit: null,
  numero_ingreso_bruto: null,
  domicilio: null,
  telefono: null,
  codigo_postal: null,
  email: null,
  saldo: null,
  retencion_ingresos_id: null,
  cuenta_id: null,
  localidad_id: null,
  provincia_id: null,
  condicion_iva_id: null,
  retencion_ganancias_id: null,
  estado: null,
})
...
<template>
  <AppLayout :breadcrumb="breadcrumbs.proveedoresCreate" title="Nuevo proveedor">
