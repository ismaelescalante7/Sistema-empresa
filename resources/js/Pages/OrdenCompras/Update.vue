...
const form = useForm({
  descripcion: props.ordenCompra.descripcion,
  proveedor_id: props.ordenCompra.proveedor_id,
  condiciones_pagos_id: props.ordenCompra.condiciones_pagos_id,
  neto: props.ordenCompra.neto,
  iva: props.ordenCompra.iva,
  total: props.ordenCompra.total,
  estado: props.ordenCompra.estado,
})

const submit = () => {
  form.patch(route('orden.compras.update', props.ordenCompra.id))
}
...
<template>
  <AppLayout :breadcrumb="breadcrumbs.ordenComprasUpdate" title="Modificar Formas de Pago">
